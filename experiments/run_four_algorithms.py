        ...
        for seed in seeds:
            ...
            for alg in base_algs:
                ...
                if alg == "tpe":
                    ...
                    cmd = [
                        python_exec,
                        "-m", "raisex.cli.algo_cli", "--algorithm", "randomalgo",
                        "--qa_json",
                        qa_json,
                        "--corpus_json",
                        corpus_json,
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Run fair-comparison experiments for GRPO/TPE/Random/MAB-UCB in raise."
    )
    ...
    if args.config_yaml:
        ...
        config_by_budget = {
            20: os.path.join(workdir, "configs", "algorithms", "default.yaml"),
            100: os.path.join(workdir, "configs", "experiments", "configforalgo_1k.yaml"),
            300: os.path.join(workdir, "configs", "experiments", "configforalgo_10k.yaml"),
        }
